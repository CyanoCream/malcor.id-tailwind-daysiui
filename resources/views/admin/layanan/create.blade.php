...
<label for="my-modal-3" class="modal cursor-pointer">
    ...
    <form class="form-control" action="{{route('create.layanan')}}" method="post" enctype="multipart/form-data">
    @csrf
    <!-- <label for="">Preview</label> -->
    <input required type="file" placeholder="Type here" name="gambar" class="input-bordered block w-full text-lg text-gray-900 bg-gray-90 rounded-lg border border-gray-400 cursor-pointer dark:text-gray-500 focus:outline-none dark:bg-gray-900 dark:border-yellow-800 dark:placeholder-gray-500" id="large_size" />
