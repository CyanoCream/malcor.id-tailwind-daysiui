    ...
    <table class="table w-full">
        ...
        <div class="alert alert-warning shadow-lg p-2 mb-1 mt-1">
            <div>
                ...
                <span>Tabel Layanan Kosong</span>
            </div>
        </div>
        @else
        ...
        <tr>
            ...
            <a href="#" class="btn btn-ghost btn-xs delete" data-id="{{$lay->id}}" data-nama="{{$lay->nama_layanan}}">Delete</a>
...
$('.delete').click( function(){
    ...
    var layanannama = $(this).attr('data-nama')
            ...
            .then((willDelete) => {
            if (willDelete) {
                window.location="/admin/delete/layanan/"+layananid+""
